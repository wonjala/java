    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
            <div class="title">Update User Info</div><br>
          <div class="sales-details">
            <%String id=request.getParameter("id");%>
                <form action="insert2?id=<%=id%>" method="post">

                    

                    <label for="username">Name</label>
                    <input type="text" name="username" placeholder="Full name" id="name">
                    <label for="address">Address</label>
                    <input type="text" name="address" placeholder="Location" id="Address">
                    <label for="email">Email</label>
                    <input type="email" name="email" placeholder="Email" id="email">
                    <label for="phone">Phone Number</label>
                    <input type="text" name="phone" placeholder="mobile number" id="number">

                    <button type="submit" name="button" value="register"> Update</button>
