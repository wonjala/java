  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
            <a href="calculatebill.jsp" class="active">
    ...
    <nav>
      <div class="sidebar-button">
       ...
       <div class="flex-contain">
          <span class="dashboard">Calculate Bill</span>
    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
            <div class="title">Calculate Bill</div><br>
          <div class="sales-details">
              <form action="testservelet" method="post">
                    ...
                    <input type="text" name="username" placeholder="User Id" id="username">

                    <label for="password">month</label>
                    <input type="month" name="month" placeholder="month" id="month">
                    <label for="password">Unit Consumed</label>
                    <input type="text" name="unit" placeholder="unit" id="unit">
                    <label for="password">Bill Due</label>
                    <input type="text" name="due" placeholder="bill due" id="billdue">



                    <button type="submit" name="button" value="calculate"> Calculate</button>
