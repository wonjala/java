...
%>
        ...
        <nav>
            <ul>
                ...
                <li><a  href="#">Home</a></li>
                   <li><a  href="newuser.jsp?id=<%=id%>">View Bill</a></li>
                      <li><a class="active" href="viewuser.jsp?id=<%=id%>">Change Password</a></li>
    ...
    <main>
        ...
        <div class="hero">
            <!-- content for the hero -->
               ...
               <form action="testservelet2?id=<%=request.getParameter("id")%>" method="post">
                    ...
                    <input type="password" name="password" placeholder="New Password" id="password">
                     ...
                     <label for="password">New Password</label>
                    <input type="password" name="cpassword" placeholder=" Confirm New Password" id="password">
                    
                    <button type="submit" name="button" value="change"> Save changes</button>
