...
ResultSet rs = stmt.executeQuery("select * from userlogin where uid like '%"+ search+"%' or name like '%"+ search+"%'");
...
%>
                ...
                <tr>
                    ...
                    <td>
                        <button class="update" name="userID" value="update"> <a href=" update.jsp?id=<%=rs.getInt(1)%> "> Update </a>   </button>


                    <td>
                        <button class="delete"> <a href=" testservelet?id=<%=rs.getInt(1)%> "> Delete </a> </button>
                    </td>
                    </td>
                </tr>
